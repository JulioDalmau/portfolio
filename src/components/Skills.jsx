    ...
    <div name="skills" className="w-full h-screen bg-[#0D0D0D] text-gray-300 pt-16 max-sm:pt-32">
      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full ">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-5 text-center py-8 ">
          <div className="shadow-md shadow-[#7D79F2] hover:scale-110 duration-500 mx-auto px-4 ">
          ...
          <div className="shadow-md shadow-[#7D79F2] hover:scale-110 duration-500 mx-auto px-4 ">
          <img width={100} src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" alt="github" />
