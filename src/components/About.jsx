...
const About = () => {
  return (
    <div name="about" className="w-full h-screen bg-[#0A0C0D] text-[#F2F2F2] max-sm:pb-24">
      <div className="flex flex-col justify-center items-center w-full h-full pt-10">
        <div className="max-w-[1000px] w-full grid grid-cols-2 gap-8">
          <div className="sm:text-left pb-8 pl-4">
            <p className="text-4xl font-bold inline border-b-4 border-[#115959] whitespace-nowrap font-montserrat">
              Sobre mí
            </p>
          </div>
          <div></div>
        ...
        <div className="max-w-[1000px] w-full grid md:grid-cols-2 gap-8 px-4">
          ...
          <div>
            ...
            <div className="justify-self-center text-center pt-4">
              ...
              <button className="text-[#F2F2F2] font-semibold py-3 px-3 border-2 my-2 hover:bg-[#2EF2BB] hover:border-[#2EF2BB] hover:text-[#0A0C0D] hover:font-semibold font-montserrat">
                {data.es.aboutMe[2]}
              </button>
                </a>
            </div>
